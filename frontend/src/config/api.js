...
export const API_ENDPOINTS = {
  ...
  staff: {
    ...
    checkIn: `${API_BASE_URL}/staff/queue/check-in`,
    markNoShow: (id) => `${API_BASE_URL}/staff/appointments/${id}/no-show`,
    cancelAppointment: (id) => `${API_BASE_URL}/staff/appointments/${id}/cancel`,
  },
  queue: {
